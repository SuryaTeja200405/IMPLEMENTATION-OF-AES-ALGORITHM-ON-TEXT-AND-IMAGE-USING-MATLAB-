...
if(enc_dec == 1)
    ...
    msg_type = 1;%input('Enter 1 for TEXT Message, 2 for IMAGE Message:\n');
    if msg_type == 1
    ...
    encode = 1;%input('Enter 1 for Sequential Encoding, 2 for Random Encoding:\n');
    if encode == 1
...
elseif enc_dec == 2
    ...
    decode = 1;%input('Enter 1 for Sequential Decoding, 2 for Random Decoding:\n');
    if decode == 1
